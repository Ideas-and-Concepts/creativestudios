...
export default function AecNavigation() {
  ...
  return <>
    <style>{`
      ...
      .cs-drawer{position:fixed;z-index:1500;inset:0 auto 0 0;width:288px;max-width:86vw;height:100dvh;max-height:100dvh;background:#fff;border-right:1px solid #e5e7eb;box-shadow:18px 0 50px rgba(15,23,42,.18);display:flex;flex-direction:column;overflow:hidden}
      ...
      @media(min-width:901px){.cs-menu-button{display:none}.cs-shell-logo{display:none}.cs-shell-actions{z-index:1400}}
