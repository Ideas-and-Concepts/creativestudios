...
export default function AecNavigation() {
  ...
  return (
    <>
      <style>{`\n        .aec-nav{position:sticky;top:0;z-index:1000;width:100%;background:#fff;border-bottom:1px solid #e2e8f0;box-shadow:0 2px 12px rgba(15,23,42,.06)}\n        .aec-nav-inner{max-width:1500px;margin:0 auto;min-height:76px;padding:10px 20px;display:grid;grid-template-columns:170px 1fr 170px;align-items:center;gap:20px}\n        .aec-brand{display:flex;align-items:center;gap:10px;text-decoration:none;color:#0f172a;min-width:0}.aec-brand img{width:44px;height:44px;object-fit:contain;display:block}.aec-brand strong{font-size:14px;line-height:1.1}.aec-brand span{display:block;color:#64748b;font-size:10px;margin-top:3px}\n        .aec-menu{display:flex;justify-content:center;align-items:center;gap:6px;flex-wrap:wrap}.aec-menu details{position:relative}.aec-menu summary{list-style:none;cursor:pointer;color:#475569;font-size:12px;font-weight:700;padding:9px 12px;border:1px solid transparent;border-radius:8px}.aec-menu summary::-webkit-details-marker{display:none}.aec-menu summary:hover,.aec-menu details[open] summary{color:#1d4ed8;background:#eff6ff;border-color:#bfdbfe}\n        .aec-dropdown{position:absolute;top:calc(100% + 6px);left:0;min-width:190px;padding:7px;background:#fff;border:1px solid #dbe4f0;border-radius:10px;box-shadow:0 12px 30px rgba(15,23,42,.12)}.aec-dropdown a{display:block;padding:9px 10px;border-radius:7px;text-decoration:none;color:#475569;font-size:12px}.aec-dropdown a:hover,.aec-dropdown a.active{background:#eff6ff;color:#1d4ed8;font-weight:700}\n        .aec-dashboard{justify-self:end;text-decoration:none;color:#1d4ed8;background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;font-size:12px;font-weight:700}.aec-dashboard:hover{background:#dbeafe}\n        @media(max-width:850px){.aec-nav-inner{grid-template-columns:1fr;gap:8px;padding:10px 14px}.aec-brand{justify-content:center}.aec-menu{justify-content:flex-start;overflow-x:auto;flex-wrap:nowrap;padding-bottom:2px}.aec-dashboard{justify-self:stretch;text-align:center}.aec-dropdown{position:fixed;left:14px;right:14px;top:130px}}\n      `}</style>
      <header className="aec-nav">
        <div className="aec-nav-inner">
          <Link href="/" className="aec-brand"><img src="/assets/creative_studios.png" alt="Creative Studios" /><div><strong>Creative Studios</strong><span>AEC Collaboration Platform</span></div></Link>
