...
def render_logo(
    ...
    """Render the Creative Studios logo safely."""
...
def inject_branding_css() -> None:
    """Inject Creative Studios application CSS."""
    ...
    st.markdown(
        ...
        /*
         * The logo is placed inside a Streamlit column.
         * These rules make sure the Streamlit image itself
         * remains centered.
         */

        .cs-login-card [data-testid="stImage"] {
            display: flex;
        ...
        .cs-login-card [data-testid="stImage"] img {
            display: block;
            margin-left: auto;
            margin-right: auto;
        }
...
def render_module_header(
    ...
    """Render a consistent module page header."""
