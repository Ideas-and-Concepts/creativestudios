...
DEFAULT_DATABASE: dict[str, Any] = {"users": [], "projects": [], "documents": [], "drawings": [], "architecture": [], "engineering": [], "mep": [], "boq": [], "construction": [], "procurement": [], "cost_control": [], "rfis": [], "tasks": [], "approvals": [], "teams": [], "site_logs": [], "site_log_workforce": [], "site_log_equipment": [], "site_log_materials": [], "site_log_activities": [], "site_log_issues": [], "site_log_instructions": [], "activity_log": [], "document_versions": [], "settings": {}}
